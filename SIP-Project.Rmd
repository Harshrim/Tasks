...
message("SVM Accuracy - Model 1")
svmAcc1
message("SVM F1 score - Model 1")
...
print(testAcc)
message("Naive Bayes F1 score - Model 1")
...
message("SVM Accuracy - Model 2")
svmAcc2
message("SVM F1 score - Model 2")
...
print(testAcc2)
message("Naive Bayes F1 score - Model 2")
...
message("SVM Accuracy - Model 3")
svmAcc3
message("SVM F1 score - Model 3")
...
print(testAcc3)
message("Naive Bayes F1 score - Model 3")
